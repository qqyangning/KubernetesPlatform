<html>
    <head>
        ...
        <script src='https://rawgit.com/ecomfe/echarts/99350dd4033ea7d3f39a4205a53ccd701f6e7433/dist/echarts.js'></script>
    ...
    <body>
        ...
        <div id='main'>
            ...
            <h1>Liquid Fill Chart (ECharts Plugin)</h1>
            <div class="nav">
                <a href="https://github.com/ecomfe/echarts-liquidfill">GitHub</a>
        ...
        <div id="view-more">
            ...
            <a href="https://github.com/ecomfe/echarts-liquidfill/blob/master/README.md">Documentation</a>
        </div>
        <script>
            var bgColor = '#E3F7FF';
